...
public final class PublicDeviceClientAuthenticationProvider implements AuthenticationProvider {

    private final RegisteredClientRepository clients;

    public PublicDeviceClientAuthenticationProvider(RegisteredClientRepository clients) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!ClientAuthenticationMethod.NONE.equals(clientAuthentication.getClientAuthenticationMethod())
                || !Boolean.TRUE.equals(clientAuthentication.getAdditionalParameters()
                        .get(PublicDeviceClientAuthenticationConverter.ELIGIBLE_REQUEST))) {
            return null;
        }
