...
public final class PublicParClientAuthenticationProvider implements AuthenticationProvider {

    private final RegisteredClientRepository clients;

    public PublicParClientAuthenticationProvider(RegisteredClientRepository clients) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!ClientAuthenticationMethod.NONE.equals(clientAuthentication.getClientAuthenticationMethod())
                || !Boolean.TRUE.equals(clientAuthentication.getAdditionalParameters()
                        .get(PublicParClientAuthenticationConverter.ELIGIBLE_REQUEST))) {
            return null;
        }
