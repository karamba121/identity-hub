...
21 baseado no TailAdmin. As cinco primeiras fatias verticais implementam
...
persistência. Tenancy, administração, logout global entre clientes, MFA,
rotação durável de chaves e operação de produção continuam planejados.
...
[004](../vertical-slices/004-oidc-logout.md) e
